...
(async () => {
  try {
    ...
    // Note: This registers commands globally. To register to a specific guild for instant updates during dev,
    // use Routes.applicationGuildCommands(process.env.CLIENT_ID, process.env.GUILD_ID)
